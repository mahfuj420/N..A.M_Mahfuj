...
#Dev:Nurul Amin Mahfuj 
##### LOGO #####
logo ="""
 \033[1;96m -------------------------------
 \033[1;32m < Kingz Tor Abbu N.A.M Mahfuj >
 \033[1;96m -------------------------------
\033[1;96m
  =====================================================
                    ASSALAMU ALAIKUM                    
            Coded By : Nurul Amin Mahfuj       
                 Facebook : fb.com/muhammadmahfuj.376               
            Facebook : facebook.com/muhammadmahfuj.376     
                Website : Ho Sob Bal E Ami dimu            
     ---------------    ---------------    ------------  
                     Kingz Tor Abbu [N.A.M]                    
  =====================================================
\033[1;32m.___  ___.      ___       __    __   _______  __    __         __  
\033[1;32m|   \/   |     /   \     |  |  |  | |   ____||  |  |  |       |  | 
\033[1;32m|  \  /  |    /  ^  \    |  |__|  | |  |__   |  |  |  |       |  | 
\033[1;32m|  |\/|  |   /  /_\  \   |   __   | |   __|  |  |  |  | .--.  |  | 
\033[1;32m|  |  |  |  /  _____  \  |  |  |  | |  |     |  `--'  | |  `--'  | 
\033[1;32m|__|  |__| /__/     \__\ |__|  |__| |__|      \______/   \______/  
...
\033[1;96m
  =====================================================
            ...
            Coded By : Nurul Amin Mahfuj       
                 Facebook : fb.com/muhammadmahfuj.376                
            Fecebook : facebook.com/muhammadmahfuj.376    
                Website : Bal Da Khola Hoy Nai           
    ---------------    ---------------    ------------  
                    Kingz Tor Abbu [N.A.M]                  
  =====================================================
\033[1;97m
...
jalan("\033[1;96m---> \033[1;32mWelcome To My Hacking Tools")
jalan("\033[1;96m---> \033[1;32mHiHi Kmon Fell Kortacho")
jalan("\033[1;96m---> \033[1;32mFacebook Id : facebook.com/muhammadmahfuj.376")
jalan("\033[1;96m---> \033[1;32mKing Is Always King")
jalan("\033[1;96m---> \033[1;32mR Jaiyen Nah Akhanei Thamen")

jalan('\033[1;96m---> \033[1;32m N.A.M Mahfuj \033[1;31m[ N.A.M ]')
print "\033[1;96m----->\033[1;32mTOOL LOGIN \033[1;96m<-----"

CorrectUsername = "N.A.M"
CorrectPassword = "Mahfuj"
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "\033[1;32mACCESS GRANTED AS " + username #Dev:N.A.M Mahfuj 
	    time.sleep(2)
            loop = 'false'
        else:
            print "\033[1;31mACCESS DENIED"
            os.system('xdg-open https://www.facebook.com/muhammadmahfuj.376')
    else:
        print "\033[1;31mACCESS DENIED"
        os.system('xdg-open https://www.facebook.com/muhammadmahfuj.376')
...
def login():
	...
	try:
		...
		jalan(' \033[1;31m---> \033[1;93mWarning: \033[1;96mAkdom Notun Account  Login Korun' )
		jalan(' \033[1;31m---> \033[1;93mWarning: \033[1;31mHaHa Kingz Tor Abbu✅' ) 
		jalan(' \033[1;31m---> \033[1;96m IM NOT King But IM King Macker Okay.  ')
		jalan(' \033[1;32m---> \033[1;96m RESPECT YOUR BOSS, I MEAN RESPECT N.A.M Mahfuj')
		jalan(' \033[1;97m--------------------------------------------------')
		...
		if 'save-device' in url:
			try:
				...
				os.system('xdg-open https://my.number// dimu nah')
...
def menu():
	...
	try:
		...
		keluar()
	os.system("clear") #Dev:Botol_Mehedi
	print logo
	...
	print "\033[1;32m<-----\033[1;93mNURUL㋡ AMIN MAHFUJ㋡\033[1;32m----->"
	print "\033[1;97m-------------------------------"
	print "\033[1;32m➥\033[1;32m1.\x1b[1;96mStart Hacking•••"
...
def super():
	...
	os.system('clear')
	print logo
	print "\033[1;32m➥\033[1;32m1.\x1b[1;96mFriend List Attack."
	print "\033[1;32m➥\033[1;32m2.\x1b[1;96mPublic I'd Attack."
...
def pilih_super():
	...
	if peak =="":
		...
		os.system('clear')
		print logo
		print "\033[1;32m<-----\033[1;93mN.A.M • YOUR UNKNOWN ASS KICKER BROTHER OF YOUR UNKNOWN SISTER ㋡ N.A.M㋡Mahfuj\033[1;32m----->"
	...
	titik = ['.   ','..  ','... ']
	for o in titik:
		print("\r\033[1;94mHacking\033[1;97m"+o),;sys.stdout.flush();time.sleep(1)
	print "\n\033[1;32m<-------\x1b[1;93m•••Stop Process Press CTRL+Z•••\033[1;32m------->"
	print "\033[1;32m<-----\033[1;93mNURUL㋡AMIN•MAHFUJ㋡\033[1;32m----->"
	jalan(' \033[1;97m•••••••••••\033[1;93mCloning Start..\033[1;97m•••••••••• ')
	jalan(' \033[1;32m<-----\033[1;93mN.A.M㋡MAHFUJ...........㋡\033[1;32m----->')
	jalan(' \033[1;97m-----------------------------------')
	...
	p = ThreadPool(50)
	p.map(main, id)
	print "\033[1;32m<-----\033[1;93mHack The World, Because Nothing Is Personal㋡ N.A.M Mahfuj ㋡\033[1;32m----->"
	print "  \033[1;93m<-----Developed By Nurul Amin Mahfuj----->" #Dev:N.A.M Mahfuj
	print '\033[1;96m✅Process Has Been Completed Press➡ Ctrl+Z.↩ Next Type (python2 MahfujBoss.py)↩\033[1;97m....'
 ...
 HaHa Amar Facebook I'd  :www.facebook.com/muhammadmahfuj.376"""
